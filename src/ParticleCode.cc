#include "ParticleCode.hh"
// Particle names should match the geant4 particle 
// names since this is currently used to translate 
// particles from external ntuple to geant 
// PrimaryGeneratorAction.cc). This is the convention
// for g4numi and has been ported into this MC.

G4String ParticleCode::AsString(ParticleCode_t pCode)
{
switch (pCode)
    {
...
G4int ParticleCode::AsInt(ParticleCode_t pCode)
{
  switch (pCode)
    {
...
ParticleCode::ParticleCode_t ParticleCode::StringToEnum(G4String pName)
{
...
ParticleCode::ParticleCode_t ParticleCode::IntToEnum(G4int particleInt)
{
//returns particle enum
  switch (particleInt)
    {
